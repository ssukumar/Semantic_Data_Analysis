...
```{r}
lex_switch_bar_all = lex_switch_bar %>% group_by(switch_status) %>% summarise(mean_norm_IRT_all = mean(mean_norm_IRT), sd_norm_IRT_all = sd(mean_norm_IRT), mean_ss_all = mean(mean_ss), sd_ss_all = sd(mean_ss), mean_norm_freq_all = mean(mean_norm_freq), sd_mean_norm_freq_all = sd(mean_norm_freq))

lex_switch_bar_all = lex_switch_bar_all %>% mutate(norm_IRT_all_min = mean_norm_IRT_all - sd_norm_IRT_all, norm_IRT_all_max = mean_norm_IRT_all + sd_norm_IRT_all, ss_all_min = mean_ss_all - sd_ss_all, ss_all_max = mean_ss_all + sd_ss_all, norm_IRT_all_min = mean_norm_freq_all - sd_norm_freq_all, norm_freq_all_max = mean_norm_freq_all + sd_norm_freq_all)
